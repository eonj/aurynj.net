...
- Spring Boot 기반 WebMVC 웹 마이크로백엔드 프로그래밍; 모던 웹 API (HTTP) 설계; React 웹 프론트엔드 프로그래밍, Node.js 라이브러리 사용: Axios, TanStack Query, Redux, MUI 등.
...
(공통 10년 1999 년 3 월 – 2009 년 2 월; 심화 2년 “자연계열” 2009 년 3 월 – 〃.)
...
대학생 게임 제작 동아리 간 모임으로 판교에서 48 시간 동안 게임을 만드는 GGG Game Jam 2016 행사에 스태프로 참여했습니다. (리포트 [🔗](<https://github.com/eonj/GGGGJ2016-Report>))
